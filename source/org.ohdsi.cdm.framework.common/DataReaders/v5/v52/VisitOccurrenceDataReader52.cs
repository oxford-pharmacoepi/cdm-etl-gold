...
namespace org.ohdsi.cdm.framework.common.DataReaders.v5.v52
{
    public class VisitOccurrenceDataReader52 : IDataReader
    {
        ...
        public VisitOccurrenceDataReader52(List<VisitOccurrence> batch, KeyMasterOffsetManager o)
        {
        ...
        public string GetName(int i)
        {
            switch (i)
            {
                ...
                case 12: return "admitting_source_concept_id";
                case 13: return "admitting_source_value";
                case 14: return "discharge_to_concept_id";
