...
{
    public class EpisodeEventDataReader54 : IDataReader
    {
        private readonly IEnumerator<EpisodeEvent> _enumerator;
        private readonly KeyMasterOffsetManager _offset;

        // A custom DataReader is implemented to prevent the need for the HashSet to be transformed to a DataTable for loading by SqlBulkCopy
        public EpisodeEventDataReader54(List<EpisodeEvent> batch, KeyMasterOffsetManager o)
        {
        ...
        public string GetName(int i)
        {
            switch (i)
            {
                ...
                case 2: return "episode_event_field_concept_id";
