...
{
    public class VisitOccurrenceDataReader54 : IDataReader
    {
        ...
        public VisitOccurrenceDataReader54(List<VisitOccurrence> batch, KeyMasterOffsetManager o)
        {
        ...
        public string GetName(int i)
        {
            switch (i)
            {
                ...
                case 14: return "discharged_to_concept_id";
                case 15: return "discharged_to_source_value";
