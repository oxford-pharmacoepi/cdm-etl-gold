...
{
    public class ConditionOccurrenceDataReader501 : IDataReader
    {
        ...
        public ConditionOccurrenceDataReader501(List<ConditionOccurrence> batch, KeyMasterOffsetManager o)
        {
