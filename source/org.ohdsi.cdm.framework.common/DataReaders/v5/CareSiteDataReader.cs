...
namespace org.ohdsi.cdm.framework.common.DataReaders.v5
{
    ...
    {
        private readonly IEnumerator<CareSite> _enumerator;
        ...
        public object GetValue(int i)
        {
            ...
            switch (i)
            {
                ...
                case 5:
                    return _enumerator.Current.PlaceOfSvcSourceValue;
        ...
        public string GetName(int i)
        {
            switch (i)
            {
                case 0: return "care_site_id";
                case 1: return "care_site_name";
                case 2: return "place_of_service_concept_id";
                case 3: return "location_id";
                case 4: return "care_site_source_value";
                case 5: return "place_of_service_source_value";
