...
{
    public class DoseEraDataReader : IDataReader
    {
        private readonly IEnumerator<DoseEra> _enumerator;
        private readonly KeyMasterOffsetManager _offset;

        // A custom DataReader is implemented to prevent the need for the HashSet to be transformed to a DataTable for loading by SqlBulkCopy
        public DoseEraDataReader(List<DoseEra> batch, KeyMasterOffsetManager o)
        {
