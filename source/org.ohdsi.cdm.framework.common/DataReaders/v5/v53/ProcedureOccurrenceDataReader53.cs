...
{
    public class ProcedureOccurrenceDataReader53 : IDataReader
    {
        ...
        public ProcedureOccurrenceDataReader53(List<ProcedureOccurrence> batch, KeyMasterOffsetManager o)
        {
