...
{
    public class VisitDetailDataReader53 : IDataReader
    {
        ...
        public VisitDetailDataReader53(List<VisitDetail> batch, KeyMasterOffsetManager o)
        {
        ...
        public string GetName(int i)
        {
            switch (i)
            {
                ...
                case 10: return "admitting_source_concept_id";
                case 11: return "discharge_to_concept_id";
                ...
                case 15: return "admitting_source_value";
                case 16: return "discharge_to_source_value";
