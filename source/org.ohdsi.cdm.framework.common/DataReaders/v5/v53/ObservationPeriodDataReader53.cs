...
{
    public class ObservationPeriodDataReader53 : IDataReader
    {
        private readonly IEnumerator<ObservationPeriod> _enumerator;
        private readonly KeyMasterOffsetManager _offset;

        // A custom DataReader is implemented to prevent the need for the HashSet to be transformed to a DataTable for loading by SqlBulkCopy
        public ObservationPeriodDataReader53(List<ObservationPeriod> batch, KeyMasterOffsetManager o)
        {
