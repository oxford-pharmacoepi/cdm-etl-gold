...
namespace org.ohdsi.cdm.framework.common.DataReaders.v5
{
    public class DrugEraDataReader : IDataReader
    {
        ...
        public DrugEraDataReader(List<EraEntity> batch, KeyMasterOffsetManager o)
        {
        ...
        public string GetName(int i)
        {
            switch (i)
            {
                ...
                case 2: return "drug_era_start_date";
                case 3: return "drug_era_end_date";
                case 4: return "drug_exposure_count";
                case 5: return "gap_days";
                default:
                    throw new NotImplementedException();
            }
        }
